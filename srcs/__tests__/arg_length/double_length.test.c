...
{
	printf(KYEL "test_long_double_int_part_length_case1\n" KNRM);
	long double	d = 3.14;

	test(
		fp_long_double_int_part_length(d) == 1,
		"double_int_part_length (3.14) : return value"
	);
}
...
{
	printf(KYEL "test_long_double_int_part_length_case2\n" KNRM);
	long double	d = -3.14;
...
{
	printf(KYEL "test_long_double_int_part_length_case3\n" KNRM);
...
{
	printf(KYEL "test_long_double_int_part_length_case4\n" KNRM);
	long double	d = -0.1231231;
...
{
	printf(KYEL "test_long_double_int_part_length_case5\n" KNRM);
...
{
	printf(KYEL "test_long_double_int_part_length_case6\n" KNRM);
	long double	d = -2000000000000000000000000000000000000000000000000.0;

	test(
		fp_long_double_int_part_length(d) == 49,
		"double_int_part_length (-2000000000000000000000000000000000000000000000000.0) : return value"
	);
}
