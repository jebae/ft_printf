...
{
	printf(KYEL "test_double_get_integer_part_case1\n" KNRM);
	short				exponent;
	...
	test(
		int_part.e == 0,
		"fp_double_get_integer_part : int_part.e"
	);

	test(
		int_part.num.occupied == 1,
		"fp_double_get_integer_part : int_part.num.occupied"
	);

	test(
		int_part.num.data[0] == 0x03,
		"fp_double_get_integer_part : int_part.num.data[0]"
	);
...
{
	printf(KYEL "test_double_get_integer_part_case2\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	t_fixedpoint		int_part;
	...
	test(
		...
		"fp_double_get_integer_part : int_part.num.data[1]"
	);

	test(
		int_part.num.data[2] == 0x01,
		"fp_double_get_integer_part : int_part.num.data[2]"
	);
...
{
	printf(KYEL "test_double_get_integer_part_case3\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	t_fixedpoint		int_part;
...
{
	printf(KYEL "test_double_get_integer_part_case4\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	t_fixedpoint		int_part;
...
{
	printf(KYEL "test_double_get_integer_part_case5\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	t_fixedpoint		int_part;
	...
	for (size_t i=0; i < int_part.num.occupied; i++)
		test(
			...
			"fp_double_get_integer_part : int_part.num.data[i]"
		);
...
{
	printf(KYEL "test_double_get_integer_part_case6\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	t_fixedpoint		int_part;
...
void		test_double_get_fraction_part_case1(void)
{
	...
	fp_double_get_fraction_part(exponent, mantissa, precision, &fraction_part);
