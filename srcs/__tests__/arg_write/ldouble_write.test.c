...
{
	printf(KYEL "test_ldouble_get_fraction_part_case1\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	...
	fp_ldouble_get_fraction_part(exponent, mantissa, precision, &fraction_part);
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case2\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case3\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case4\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case5\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case6\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case7\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
...
{
	printf(KYEL "test_ldouble_get_fraction_part_case8\n" KNRM);
	short				exponent;
	unsigned long long	mantissa;
	size_t				precision;
	t_fixedpoint		fraction_part;
