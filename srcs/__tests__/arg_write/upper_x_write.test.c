...
void		test_arg_upper_x_write_case1(void)
{
	...
	fp_init_buffer(&buf);
	data.i = 0x12345678;
	fp_arg_upper_x_write(&data, NULL, fp_arg_x_length(&data, NULL), &buf);
...
void		test_arg_h_upper_x_write_case1(void)
{
	...
	fp_init_buffer(&buf);
	data.i = 0xFEDA;
	fp_arg_h_upper_x_write(&data, NULL, fp_arg_hx_length(&data, NULL), &buf);
...
void		test_arg_hh_upper_x_write_case1(void)
{
	...
	fp_init_buffer(&buf);
	data.i = 0xfe;
	fp_arg_hh_upper_x_write(&data, NULL, fp_arg_hhx_length(&data, NULL), &buf);
...
void		test_arg_l_upper_x_write_case1(void)
{
	...
	fp_arg_l_upper_x_write(&data, NULL, fp_arg_lx_length(&data, NULL), &buf);
...
void		test_arg_ll_upper_x_write_case1(void)
{
	...
	fp_init_buffer(&buf);
	data.i = 0x12345678abcdef01;
	fp_arg_ll_upper_x_write(&data, NULL, fp_arg_llx_length(&data, NULL), &buf);
